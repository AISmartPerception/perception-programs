...
def run_qwen_with_pp_batched(output_root,
    ...
    annotations = load_jsonl("/data00/hugo/blink_annotations/Object_Localization_val_annotations.jsonl")
    obj_loc_detections = fetch_obj_loc_pp("/home/perception-programs/object_loc/detections.jsonl")
...
if __name__ == "__main__":
    output_root = f"/data00/object_localization/open-source-models/qwen4b-{mode.lower()}/pp/"
