...
def run_vanilla_qwen_batched(output_root, data,
...
if __name__ == "__main__":
    output_root = f"/data00/depth/open-source-models/qwen4b-{mode.lower()}/vanilla/"
    dataset = fetch_hardblink_data()
    run_vanilla_qwen_batched(output_root, dataset)
